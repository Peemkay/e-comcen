"""
Convert SVG to ICO file with multiple sizes for Windows application.
This script requires cairosvg and Pillow packages.
"""
import os
import io
import cairosvg
...
def svg_to_png(svg_file, output_size):
    ...
    png_data = cairosvg.svg2png(url=svg_file, output_width=output_size, output_height=output_size)
