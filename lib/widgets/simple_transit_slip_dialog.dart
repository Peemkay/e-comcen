...
import '../services/transit_slip_generator.dart';
import '../screens/reports/pdf_preview_screen.dart';

/// A simplified dialog for generating Transit Slip reports
class SimpleTransitSlipDialog extends StatefulWidget {
  const SimpleTransitSlipDialog({super.key});

  @override
  State<SimpleTransitSlipDialog> createState() =>
      _SimpleTransitSlipDialogState();
}

class _SimpleTransitSlipDialogState extends State<SimpleTransitSlipDialog> {
  final TransitSlipGenerator _transitSlipGenerator = TransitSlipGenerator();
