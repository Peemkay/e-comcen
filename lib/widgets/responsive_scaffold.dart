      ...
      responsiveBody = SingleChildScrollView(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            // Calculate minimum height to ensure content fills the screen
            // Subtract app bar height and bottom navigation bar height if present
            double minHeight = screenHeight;
            if (appBar != null) {
              minHeight -= appBar!.preferredSize.height;
            }
            // Approximate bottom navigation bar height
            if (bottomNavigationBar != null) {
              minHeight -= kBottomNavigationBarHeight;
            }
            // Subtract safe area padding
