...
class UserConnectionService {
  // Singleton pattern
  static final UserConnectionService _instance = UserConnectionService._internal();
  ...
  Future<void> _updateUserConnection(User user) async {
    try {
      ...
      await _firebaseService.firestore
        ...
        'isActive': true,
        'appType': 'dispatcher', // Indicate this is the dispatcher app
  ...
  Future<void> _sendHeartbeat() async {
    try {
      if (_firebaseService.currentUnitId == null || _connectionId == null || _currentUser == null) return;
