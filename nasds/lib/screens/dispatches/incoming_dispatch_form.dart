...
class _IncomingDispatchFormState extends State<IncomingDispatchForm> {
  ...
  final _senderUnitController = TextEditingController();
  ...
  void initState() {
    ...
    if (_isEditing) {
      ...
      _senderUnitController.text = widget.dispatch!.senderUnit;
  ...
  void _saveDispatch() {
    if (_formKey.currentState!.validate()) {
      ...
      final dispatch = IncomingDispatch(
        ...
        senderUnit: _senderUnitController.text,
